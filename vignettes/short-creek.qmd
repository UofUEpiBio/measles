...
For calibration, we can make use of the function `calibrate_mixing_model()`, which will give us the needed scaleing factor to apply to the transmission probability (or contact matrix) to get the desired R0. In this case, we will use an R0 of 12, which is consistent with the literature on measles.
